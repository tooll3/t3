...
namespace T3.Operators.Types.Id_816eda66_79c3_430c_9f03_d51b93b17987
{
    public class DrawImageMosaic : Instance<DrawImageMosaic>
    {
        ...
        public readonly Slot<Command> Render = new Slot<Command>();
        ...
        public readonly InputSlot<string> ImageFolder = new InputSlot<string>();
        ...
        public readonly InputSlot<SharpDX.Direct3D11.Texture2D> ReferenceImage = new InputSlot<SharpDX.Direct3D11.Texture2D>();
