...
namespace T3.Operators.Types.Id_daacabd8_0338_4998_898f_94580abd8eac
{
    public class ScatterMeshFaces : Instance<ScatterMeshFaces>
    {
        ...
        public readonly InputSlot<float> Push = new InputSlot<float>();

        [Input(Guid = "77c28c83-7592-4ab3-b7ca-d64a176965b1")]
        public readonly InputSlot<float> Shrink = new InputSlot<float>();
