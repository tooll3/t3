...
namespace T3.Operators.Types.Id_185452c6_f299_42a3_b618_c6aa00d66c62
{
    public class DefineGradient : Instance<DefineGradient>
    {
        ...
        public DefineGradient()
        {
            ...
            _slots = new List<Pair>
                            {
                                new Pair {PositionSlot = Color1Pos,ColorSlot= Color1},
                                new Pair {PositionSlot = Color2Pos,ColorSlot= Color2},
                                new Pair {PositionSlot = Color3Pos,ColorSlot= Color3},
                                new Pair {PositionSlot = Color4Pos,ColorSlot= Color4},
                            };
        }
