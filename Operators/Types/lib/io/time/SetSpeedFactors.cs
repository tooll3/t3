...
namespace T3.Operators.Types.Id_61dc8ba5_8aa6_4003_8d8c_8bce27f56a67
{
    public class SetSpeedFactors : Instance<SetSpeedFactors>
    {
        ...
        public readonly MultiInputSlot<T3.Core.DataTypes.Command> Commands = new MultiInputSlot<T3.Core.DataTypes.Command>();
        ...
        public readonly InputSlot<float> SpeedFactorA = new InputSlot<float>();

        [Input(Guid = "c6cc12b7-96e6-406c-8e91-56fa70a241a2")]
        public readonly InputSlot<float> SpeedFactorB = new InputSlot<float>();

        [Input(Guid = "14a0ee21-309a-44cc-bc00-3d7d5594de01", MappedType = typeof(Modes))]
        public readonly InputSlot<int> ApplyAs = new InputSlot<int>();
