...
namespace T3.Operators.Types.Id_2cc44046_2702_40d5_ab42_8b36ff3d6ca7
{
    public class AxisStepForce : Instance<AxisStepForce>
    {
        ...
        public readonly InputSlot<bool> ApplyTrigger = new InputSlot<bool>();
        ...
        public readonly InputSlot<float> SelectRatio = new InputSlot<float>();

        [Input(Guid = "4701df38-3ec8-4133-ba40-afdf859e8f2f")]
        public readonly InputSlot<System.Numerics.Vector3> AxisDistribution = new InputSlot<System.Numerics.Vector3>();

        [Input(Guid = "25e77db3-6ccb-4857-8dd6-e5c19395d85b")]
        public readonly InputSlot<float> AddOriginalVelocity = new InputSlot<float>();
