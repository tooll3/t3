...
namespace T3.Operators.Types.Id_e44ae9b6_cd56_4224_8a5d_118eda4cd3f4
{
    public class ParticleSystem : Instance<ParticleSystem>
    {
        ...
        public readonly InputSlot<float> RadiusFromW = new();
        ...
        public readonly InputSlot<float> OrientTowardsVelocity = new();
        ...
        public readonly InputSlot<int> SetWTo = new();
        
        [Input(Guid = "c41d9633-1397-4602-a5f8-7808c3d63108")]
        public readonly MultiInputSlot<T3.Core.DataTypes.ParticleSystem> ParticleEffects = new();

        [Input(Guid = "21c666bb-a28f-498c-a834-a2ba4aca78a7", MappedType = typeof(EmitModes))]
        public readonly InputSlot<int> EmitMode = new();
