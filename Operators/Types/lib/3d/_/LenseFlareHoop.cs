...
namespace T3.Operators.Types.Id_393da0ad_00ef_4a9c_bd53_9314bb16b08b
{
    public class LenseFlareHoop : Instance<LenseFlareHoop>
    {
        ...
        public readonly InputSlot<float> RandomizeSize = new InputSlot<float>();
        ...
        public readonly InputSlot<System.Numerics.Vector2> PositionFactor = new InputSlot<System.Numerics.Vector2>();

        [Input(Guid = "03cafdc8-c009-418a-a24a-526a358d5cf3")]
        public readonly InputSlot<int> FxZoneMode = new InputSlot<int>();

        [Input(Guid = "9447da2e-f9b6-4fc9-a523-c7db580d272b")]
        public readonly InputSlot<System.Numerics.Vector2> EdgeFxZone = new InputSlot<System.Numerics.Vector2>();

        [Input(Guid = "c822325b-c19c-4a69-a9a6-7a2b2d09264d")]
        public readonly InputSlot<System.Numerics.Vector2> InnerFxZone = new InputSlot<System.Numerics.Vector2>();

        [Input(Guid = "49bce40f-13cd-4210-8102-6cc74308be52")]
        public readonly InputSlot<float> FxZoneScale = new InputSlot<float>();

        [Input(Guid = "9de875e5-218f-49a8-9fe3-3330abb87e83")]
        public readonly InputSlot<float> FxZoneBrightness = new InputSlot<float>();
        ...
        public readonly InputSlot<float> SegmentWidth = new InputSlot<float>();
