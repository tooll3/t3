...
,ICameraPropertiesProvider,ICamera
    {
        ...
        private void UpdateCameraDefinition(EvaluationContext context)
        {
            ...
            // Orbit rotation
            Vector3 t = Center.GetValue(context);
        ...
        public readonly InputSlot<Vector2> OrbitAngleAndWobble = new();
        
        [Input(Guid = "7412E22C-1F15-4471-883B-4FCD792146F7")]
        public readonly InputSlot<Vector2> SpinAngleAndWobble = new();

        
        [Input(Guid = "4D2D2D2D-00BD-4DF9-B209-62F0C7926C38")]
        public readonly InputSlot<Vector2> AimPitchAngleAndWobble = new();
        
        [Input(Guid = "066CD0E7-DE72-4E04-BF13-686CCC301C5A")]
        public readonly InputSlot<Vector2> AimYawAngleAndWobble = new();

        [Input(Guid = "1AF76B2E-CFFE-4E3F-8793-C7A59D00430B")]
        public readonly InputSlot<Vector2> AimRollAngleAndWobble = new();
