...
namespace T3.Operators.Types.Id_eb818dd0_0c9c_40ee_b76e_2148f958b987
{
    public class ScaleResolution : Instance<ScaleResolution>
    {
        ...
        public readonly Slot<Int2> Size = new Slot<Int2>();
        ...
        public readonly InputSlot< System.Numerics.Vector2> Factor = new InputSlot<System.Numerics.Vector2>();
        
        [Input(Guid = "D14B7C37-E012-4659-98E9-226AB97291BE")]
        public readonly InputSlot<bool> ClampToValidTextureSize = new InputSlot<bool>();
    }
}
