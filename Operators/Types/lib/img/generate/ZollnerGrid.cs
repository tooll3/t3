...
namespace T3.Operators.Types.Id_f2a0a8d9_e2dc_476b_ac97_de13101a6fdb
{
    public class ZollnerGrid : Instance<ZollnerGrid>
    {
        ...
        public readonly InputSlot<float> HookRotation = new InputSlot<float>();

        [Input(Guid = "71765e67-2057-4819-b406-0382c1ab0893")]
        public readonly InputSlot<float> HookLength = new InputSlot<float>();

        [Input(Guid = "901206a2-c432-41c7-910b-f2f419b913af")]
        public readonly InputSlot<float> HookWidth = new InputSlot<float>();
        ...
        public readonly InputSlot<float> GAffects_HookLength = new InputSlot<float>();

        [Input(Guid = "8f8a92bf-cdc6-45cd-9ff7-5d01cd31bd8e")]
        public readonly InputSlot<float> BAffects_HookRotation = new InputSlot<float>();
