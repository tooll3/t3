...
namespace T3.Operators.Types.Id_6820b166_1782_43b9_bc5c_6b4f63b16f86
{
    public class FakeLight : Instance<FakeLight>
    {
        ...
        public readonly InputSlot<SharpDX.Direct3D11.Texture2D> HeightMap = new();
        ...
        public readonly InputSlot<float> Specularity = new();
        ...
        public readonly InputSlot<System.Numerics.Vector4> MidColor = new();
