...
namespace T3.Operators.Types.Id_84a93ea9_98fb_4088_a1e9_87454f7292f1
{
    public class DrawPointsAsSpheres : Instance<DrawPointsAsSpheres>
    {
        ...
        [Input(Guid = "bb8e9be9-1371-45fd-be67-93d183b1355e")]
        ...
        [Input(Guid = "09653e6e-d4e2-4f71-850a-17ef94209550")]
        public readonly InputSlot<float> Shaded = new InputSlot<float>();
    }
}
