...
namespace T3.Operators.Types.Id_f925e9b9_5c7a_4fbf_9572_b11fe2d54d6c
{
    public class ApplyRandomWalk : Instance<ApplyRandomWalk>
    {
        ...
        public readonly InputSlot<bool> TriggerStep = new InputSlot<bool>();

        [Input(Guid = "351e1da3-a8ab-4625-b7c6-0c14703a94d9")]
        public readonly InputSlot<float> StepWidth = new InputSlot<float>();

        [Input(Guid = "a5f770ae-7f1d-4b45-93e9-d31ba7f62932")]
        public readonly InputSlot<float> TurnAngle = new InputSlot<float>();

        [Input(Guid = "23a45ab7-7f40-4f6d-91ff-5ecaf9ffe221")]
        public readonly InputSlot<float> StepRatio = new InputSlot<float>();

        [Input(Guid = "e0326849-5e5b-41fb-b53e-0a2c0eafca12")]
        public readonly InputSlot<float> TurnRatio = new InputSlot<float>();

        [Input(Guid = "065cafa7-8da9-428b-aef7-5ce7f969f293")]
        public readonly InputSlot<float> RandomStepWidth = new InputSlot<float>();

        [Input(Guid = "b70f51c3-b64f-417e-a22f-e9f790e0259a")]
        public readonly InputSlot<float> RandomRotateAngle = new InputSlot<float>();

        [Input(Guid = "87b7a45e-dad8-4d5b-93af-7ed743ac8237")]
        public readonly InputSlot<System.Numerics.Vector2> AreaEdgeRange = new InputSlot<System.Numerics.Vector2>();

        [Input(Guid = "b4cabe59-4166-490c-be8d-12eb9d5fe3c4")]
        public readonly InputSlot<System.Numerics.Vector2> AreaCenter = new InputSlot<System.Numerics.Vector2>();
