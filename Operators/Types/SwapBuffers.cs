...
namespace T3.Operators.Types.Id_020573c5_acaa_442e_9b1b_01338b0f4b62
{
    public class SwapBuffers : Instance<SwapBuffers>
    {
        ...
        public readonly Slot<T3.Core.DataTypes.BufferWithViews> BufferA = new Slot<T3.Core.DataTypes.BufferWithViews>();

        [Output(Guid = "99175A08-D0FF-417B-B65C-CA18938EA03C")]
        public readonly Slot<T3.Core.DataTypes.BufferWithViews> BufferB = new Slot<T3.Core.DataTypes.BufferWithViews>();
        ...
        public readonly InputSlot<T3.Core.DataTypes.BufferWithViews> BufferAInput = new InputSlot<T3.Core.DataTypes.BufferWithViews>();

        [Input(Guid = "DE95E30B-896E-4880-B940-82863554CE02")]
        public readonly InputSlot<T3.Core.DataTypes.BufferWithViews> BufferBInput = new InputSlot<T3.Core.DataTypes.BufferWithViews>();

        [Input(Guid = "3DC564AD-B534-4170-92A2-BF860D3604CB")]
        public readonly InputSlot<bool> EnableSwap = new InputSlot<bool>();
