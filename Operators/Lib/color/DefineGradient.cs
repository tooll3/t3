...
namespace lib.color
{
    ...
    public class DefineGradient : Instance<DefineGradient>
    {
        ...
        private class Pair
        {
            ...
            public InputSlot<System.Numerics.Vector4> ColorSlot;
        }

        private List<Pair> _slots;
        
        [Input(Guid = "4723C177-9941-4FCB-9D5A-9A4ED18F3B5F")]
        public readonly InputSlot<System.Numerics.Vector4> Color1 = new();
        ...
        public readonly InputSlot<System.Numerics.Vector4> Color2 = new();
        ...
        public readonly InputSlot<System.Numerics.Vector4> Color3 = new();
        ...
        public readonly InputSlot<System.Numerics.Vector4> Color4 = new();
