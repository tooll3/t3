...
namespace lib.img.fx
{
    ...
    public class GlitchDisplace : Instance<GlitchDisplace>
    {
        ...
        public readonly InputSlot<System.Numerics.Vector2> Scatter = new();
        ...
        public readonly InputSlot<System.Numerics.Vector2> ScatterStretch = new();
        ...
        public readonly InputSlot<System.Numerics.Vector2> ScatterOffset = new();
        ...
        public readonly InputSlot<float> ColorRatio = new();
        ...
        public readonly InputSlot<T3.Core.DataTypes.BufferWithViews> OverridePoints = new();
