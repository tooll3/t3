...
namespace lib.img.fx.@_
{
    ...
    public class BlurWithMask : Instance<BlurWithMask>
    {
        ...
        public readonly InputSlot<float> AddOriginal = new();

        [Input(Guid = "731eaf1c-aef0-4310-a470-62c0dfeb310a")]
        public readonly InputSlot<float> ApplyMaskToAlpha = new();

        [Input(Guid = "d89ac5e9-9bdd-48f6-8118-3bbe04e3988d")]
        public readonly InputSlot<float> MaskContrast = new();

        [Input(Guid = "684761a9-3bdf-4ef3-8d3e-191332609ecf")]
        public readonly InputSlot<float> MaskOffset = new();
