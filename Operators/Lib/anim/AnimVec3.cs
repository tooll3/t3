...
namespace lib.anim
{
    ...
    public class AnimVec3 : Instance<AnimVec3>
    {
        ...
        public readonly InputSlot<System.Numerics.Vector3> Rates = new();
        ...
        public readonly InputSlot<System.Numerics.Vector3> Phases = new();

        [Input(Guid = "AAD62703-647D-437B-879B-08793AC8802F")]
        public readonly InputSlot<System.Numerics.Vector3> Amplitudes = new();
        ...
        public readonly InputSlot<System.Numerics.Vector3> Offsets = new();
