...
namespace lib.math.int2
{
    ...
    public class MaxInt2 : Instance<MaxInt2>
    {
        ...
        public readonly Slot<T3.Core.DataTypes.Vector.Int2> MaxSize = new();
        ...
        private void Update(EvaluationContext context)
        {
            ...
            MaxSize.Value = new T3.Core.DataTypes.Vector.Int2(maxWidth, maxHeight);
        }
        
        
        [Input(Guid = "3FE2016D-C4BC-42E1-A3D8-F8BC34CFCF32")]
        public readonly MultiInputSlot<T3.Core.DataTypes.Vector.Int2> Sizes = new();
    }
}
