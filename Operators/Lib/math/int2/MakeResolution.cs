...
namespace lib.math.int2
{
    ...
    public class MakeResolution : Instance<MakeResolution>
    {
        ...
        public readonly Slot<T3.Core.DataTypes.Vector.Int2> Size = new();
        ...
        {
            Size.Value= new T3.Core.DataTypes.Vector.Int2(Width.GetValue(context), Height.GetValue(context));
        }
