...
namespace lib.math.int2
{
    ...
    public class ScaleSize : Instance<ScaleSize>
    {
        ...
        private void Update(EvaluationContext context)
        {
            ...
            Result.Value = new T3.Core.DataTypes.Vector.Int2((int)(source.Width * factor), (int)(source.Height * factor));
        }
        
        [Input(Guid = "DDCEB7DF-1C6F-4545-9669-B1B4A80E75E8")]
        public readonly InputSlot<T3.Core.DataTypes.Vector.Int2> InputSize = new();
