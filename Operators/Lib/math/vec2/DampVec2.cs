...
namespace lib.math.vec2
{
    ...
    public class DampVec2 : Instance<DampVec2>
    {
        ...
        private void Update(EvaluationContext context)
        {
            ...
            MathUtils.ApplyDefaultIfInvalid(ref _dampedValue, System.Numerics.Vector2.Zero);
            MathUtils.ApplyDefaultIfInvalid(ref _velocity, System.Numerics.Vector2.Zero);
            Result.Value = _dampedValue;
        }

        private System.Numerics.Vector2 _dampedValue;
