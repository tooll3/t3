...
namespace lib.math.vec2
{
    ...
    public class RemapVec2 : Instance<RemapVec2>
    {
        ...
        private void Update(EvaluationContext context)
        {
            ...
            switch ((Modes)Mode.GetValue(context))
            {
                ...
                case Modes.Modulo:
                {
                    ...
                    v = new System.Numerics.Vector2(MathUtils.Fmod(v.X, delta.X),
        ...
        public readonly InputSlot<System.Numerics.Vector2> RangeInMin = new();

        [Input(Guid = "80A87FE2-9CCC-4A3D-AE39-44BA4431CB9B")]
        public readonly InputSlot<System.Numerics.Vector2> RangeInMax = new();

        [Input(Guid = "0E1C8A24-5183-4DCA-9726-39368AC4A6C4")]
        public readonly InputSlot<System.Numerics.Vector2> RangeOutMin = new();

        [Input(Guid = "CF991EF5-976D-4536-9A69-E6277A1A914E")]
        public readonly InputSlot<System.Numerics.Vector2> RangeOutMax = new();
