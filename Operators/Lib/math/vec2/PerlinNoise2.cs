...
namespace lib.math.vec2
{
    ...
    public class PerlinNoise2 : Instance<PerlinNoise2>
    {
        ...
        private void Update(EvaluationContext context)
        {
            ...
            Result.Value  = new System.Numerics.Vector2(x, y) * scaleXY  * scale;
        }
        ...
        public readonly InputSlot<System.Numerics.Vector2> AmplitudeXY = new();
        ...
        public readonly InputSlot<System.Numerics.Vector2> RangeMin = new();

        [Input(Guid = "DAE5B55C-0C30-4EE9-A535-7654B8357669")]
        public readonly InputSlot<System.Numerics.Vector2> RangeMax = new();
