...
namespace lib.point.draw
{
    ...
    public class DrawBillboards : Instance<DrawBillboards>
    {
        ...
        public readonly InputSlot<Gradient> ColorVariations = new InputSlot<Gradient>();
        ...
        public readonly InputSlot<Curve> Scales = new InputSlot<Curve>();
        ...
        public readonly InputSlot<Texture2D> FxTexture = new InputSlot<Texture2D>();
