...
namespace lib._3d.postfx
{
    ...
    public class GodRays : Instance<GodRays>
    {
        ...
        public readonly InputSlot<System.Numerics.Vector4> RayColor = new();
        ...
        public readonly InputSlot<float> Rays = new();

        [Input(Guid = "59568136-2903-4fd5-a504-8a6308a2a2dc")]
        public readonly InputSlot<int> Samples = new();

        [Input(Guid = "6d985988-3107-4480-8852-f17fe1c6d002")]
        public readonly InputSlot<float> ShiftDepth = new();
        ...
        public readonly InputSlot<int> BlurSamples = new();
