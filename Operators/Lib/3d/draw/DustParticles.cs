...
namespace lib._3d.draw
{
    ...
    public class DustParticles : Instance<DustParticles>
    {
        ...
        public readonly InputSlot<float> WrapSize = new();
        ...
        public readonly InputSlot<System.Numerics.Vector4> TrailColor = new();

        [Input(Guid = "31cfdca2-7f14-4c88-93ca-6f160829ca78")]
        public readonly InputSlot<float> TrailWidth = new();
        ...
        public readonly InputSlot<System.Numerics.Vector3> OffsetVolume = new();
