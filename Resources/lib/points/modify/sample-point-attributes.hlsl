                                  ...
                                  : SV_DispatchThreadID)
{
  ...
  if (rotXFactor != 0)
  {
    rot = qmul(rot, rotate_angle_axis(rotXFactor * tau, float3(1, 0, 0)));
  }
  if (rotYFactor != 0)
  {
    rot = qmul(rot, rotate_angle_axis(rotYFactor * tau, float3(0, 1, 0)));
  }
  if (rotZFactor != 0)
  {
    rot = qmul(rot, rotate_angle_axis(rotZFactor * tau, float3(0, 0, 1)));
  }
