...
{
    public class Int2InputUi : IntVectorInputValueUi<Int2>
    {
        ...
        protected override InputEditStateFlags DrawEditControl(string name, SymbolChild.Input input, ref Int2 int3Value, bool readOnly)
        {
