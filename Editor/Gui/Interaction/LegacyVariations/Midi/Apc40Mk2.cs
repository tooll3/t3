...
namespace Editor.Gui.Interaction.LegacyVariations.Midi
{
    ...
    {
        public Apc40Mk2(LegacyVariationHandling variationHandling)
        {
        ...
        public override void Update(LegacyVariationHandling variationHandling, MidiIn midiIn, OperatorVariation activeVariation)
        {
            ...
            UpdateRangeLeds(midiOut, SceneTrigger1To40,
                            mappedIndex =>
                            {
                                ...
                                switch (p.State)
                                {
                                    case LegacyPreset.States.Undefined:
                                        color = Apc40Colors.Off;
                                        break;
                                    case LegacyPreset.States.InActive:
