...
namespace T3.Gui.Interaction.LegacyVariations.Midi
{
    ...
    {
        void Update(LegacyVariationHandling variationHandling, MidiIn midiIn, OperatorVariation activeVariation);
    ...
    public abstract class AbstractMidiDevice : IControllerInputDevice, MidiInConnectionManager.IMidiConsumer
    {
        ...
        public virtual void Update(LegacyVariationHandling variationHandling, MidiIn midiIn, OperatorVariation activeVariation)
        {
