...
namespace T3.Gui.Interaction.LegacyVariations.Model
{
    /// <summary>
    ...
    public partial class OperatorVariation
    {
        ...
        internal void ActivatePreset(ParameterGroup group, LegacyPreset preset)
        {
        ...
        private bool TryGetPreset(PresetAddress address, out LegacyPreset preset)
        {
            preset = null;
        ...
        internal void StartBlendTransitionIntoPreset(ParameterGroup group, LegacyPreset targetPreset)
        {
        ...
        private LegacyPreset CreatePresetForGroup(ParameterGroup group)
        {
            ...
            var newPreset = new LegacyPreset();
            foreach (var parameter in group.Parameters)
            {
                if (parameter == null)
                    continue;
        ...
        private void ApplyGroupPreset(ParameterGroup group, LegacyPreset preset)
        {
        ...
        private void BlendTwoPresets(ParameterGroup group, LegacyPreset groupBlendedPresetA, LegacyPreset groupBlendedPresetB, float localBlendFactor)
        {
            var commands = new List<ICommand>();
            var symbol = CompositionInstance.Symbol;
            foreach (var parameter in group.Parameters)
