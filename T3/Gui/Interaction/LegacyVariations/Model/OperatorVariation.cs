...
namespace T3.Gui.Interaction.LegacyVariations.Model
{
    ...
    public partial class OperatorVariation
    {
        ...
        public LegacyPreset[,] Presets = new LegacyPreset[4, 4];
        ...
        public IEnumerable<LegacyPreset> GetPresetsForGroup(ParameterGroup group)
        {
            var groupIndex = GetIndexForGroup(group);
            if (groupIndex == -1)
            {
        ...
        //----------------------------------------------------------------------------------------
        #region presets
        public LegacyPreset TryGetPresetAt(PresetAddress address)
        {
        ...
        public void SetPresetAt(LegacyPreset preset, PresetAddress address)
        {
        ...
        public static OperatorVariation ReadFromJson(Guid compositionId)
        {
            ...
            using (var jsonReader = new JsonTextReader(sr))
            {
                ...
                // Presets
                {
                    ...
                    newOpVariation.Presets = new LegacyPreset[groupCount, sceneCount];
                    ...
                    for (var groupIndex = 0; groupIndex < groupCount; groupIndex++)
                    {
                        for (var sceneIndex = 0; sceneIndex < sceneCount; sceneIndex++)
                        {
                            ...
                            newOpVariation.Presets[groupIndex, sceneIndex] = presetToken.HasValues
                                                                             ? LegacyPreset.FromJson(presetToken)
                                                                             : null;
